...
func TestToPostfix(t *testing.T) {
  tests := []struct {
    ...
    {
      input: []Token{{Type: NUMBER, Value: "3"}, {Type: PLUS, Value: "+"}, {Type: NUMBER, Value: "4"}, {Type: EOF, Value: ""}},
      expected: "3 4 +",
      hasError: false,
    },
    {
      input: []Token{{Type: NUMBER, Value: "3"}, {Type: MULTIPLY, Value: "*"}, {Type: LPAREN, Value: "("}, {Type: NUMBER, Value: "4"}, {Type: PLUS, Value: "+"}, {Type: NUMBER, Value: "5"}, {Type: RPAREN, Value: ")"}, {Type: EOF, Value: ""}},
      expected: "3 4 5 + *",
      hasError: false,
    },
    {
      input: []Token{{Type: LPAREN, Value: "("}, {Type: NUMBER, Value: "3"}, {Type: PLUS, Value: "+"}, {Type: NUMBER, Value: "4"}, {Type: RPAREN, Value: ")"}, {Type: EOF, Value: ""}},
      expected: "3 4 +",
      hasError: false,
    },
    {
      input: []Token{{Type: NUMBER, Value: "3"}, {Type: RPAREN, Value: ")"}, {Type: EOF, Value: ""}},
      expected: "",
      hasError: true,
    },
  }
...
func TestEvaluateMathExpression(t *testing.T) {
  ...
  for _, test := range tests {
    res, err := evaluateMathExpression(test.input)
    if test.hasError {
      if err == nil {
